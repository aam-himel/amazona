  ...
  <Router history={history}>
    <>
      ...
      <Switch>
        ...
        <Route component={view.Phone} exact path={ROUTES.PHONE} />
        ...
        <Route component={view.AutoMobile} exact path={ROUTES.AUTO_MOBILE} />

        <Route component={view.Wardrobe} exact path={ROUTES.WARDROBE} />
